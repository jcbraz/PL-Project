...
_lr_productions = [
  ...
  ('array -> LBRACKET values RBRACKET','array',3,'p_array','_parser.py',68),
  ('array -> LBRACKET array RBRACKET','array',3,'p_array','_parser.py',69),
  ('array -> LBRACKET RBRACKET','array',2,'p_array','_parser.py',70),
  ('values -> value COMMA values','values',3,'p_values','_parser.py',78),
  ('values -> value','values',1,'p_values','_parser.py',79),
  ('value -> STRING','value',1,'p_value','_parser.py',87),
  ('value -> INTEGER','value',1,'p_value','_parser.py',88),
  ('value -> FLOAT','value',1,'p_value','_parser.py',89),
  ('value -> BOOLEAN','value',1,'p_value','_parser.py',90),
  ('value -> DATE','value',1,'p_value','_parser.py',91),
]
